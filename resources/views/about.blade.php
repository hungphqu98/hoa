<x-app-layout>
  <nav data-depth="2" class="breadcrumb">
    <div class="container">
      <ol itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <a itemprop="item" href="{{ route('about') }}">
  ...
  <div class="container " >
      ...
      <p>Bên cạnh đó, Chúng tôi hiểu rằng giá cả cũng là một yếu tố quan trọng khác trong việc lựa chọn mua hoa. Vì vậy, chúng tôi cam kết cung cấp sản phẩm với giá cả hợp lý và cạnh tranh trên thị trường.</p>
      <p><b>Gia Flowers</b> tự hào là điểm đến tin cậy cho những người yêu hoa và người tìm kiếm những món quà đặc biệt và ý nghĩa. Chúng tôi cung cấp một loạt các loại lan hồ điệp với các thiết kế đa dạng độc đáo và các loại hoa tươi đa sắc, từ các loại chậu hoa, hoa cắt cành cho đến các sản phẩm hoa thành phẩm. Bất kể dịp đặc biệt nào, chúng tôi sẽ tạo ra những thiết kế hoa từ tâm để làm hài lòng khách hàng.</p>
  </div>
  </div>
</x-app-layout>